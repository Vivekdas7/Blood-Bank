      ...
      <div className="flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md m-3 p-6 text-gray-800">
            <h2 className="text-lg font-semibold mb-2 text-[#d04742]">Event 1</h2>
            ...
            <button className="mt-4   hover:bg-red-700 text-red-700 hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded mt-4">Register</button>
          </div>
          <div className="bg-white rounded-lg shadow-md m-3 p-6 text-gray-800">
            <h2 className="text-lg font-semibold mb-2x text-[#d04742]">Event 2</h2>
          ...
          <div className="bg-white rounded-lg shadow-md m-3 p-6 text-gray-800">
            <h2 className="text-lg font-semibold mb-2 text-[#d04742] ">Event 3</h2>
